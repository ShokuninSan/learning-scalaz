...
/** Both (*2) and (+10) get applied to the number 3 in this case. return (a+b)
  * does as well, but it ignores it and always presents a+b as the result. For
  * this reason, the function monad is also called the reader monad. All the
  * functions read from a common source.
  *
  */
